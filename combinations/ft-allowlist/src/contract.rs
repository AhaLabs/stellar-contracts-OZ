//! SEP-41 fungible token with AllowList transfer restriction, AccessControl, Burnable, and Upgradeable.
...
use stellar_tokens::fungible::{burnable::FungibleBurnable, allowlist::{AllowList, FungibleAllowList}, Base, FungibleToken};
