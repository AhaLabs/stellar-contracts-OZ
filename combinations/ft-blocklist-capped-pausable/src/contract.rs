//! Capped and pausable SEP-41 fungible token with BlockList, AccessControl, Burnable, and Upgradeable.
...
use stellar_tokens::fungible::{burnable::FungibleBurnable, capped::{check_cap, set_cap}, blocklist::{BlockList, FungibleBlockList}, ContractOverrides, Base, FungibleToken};
