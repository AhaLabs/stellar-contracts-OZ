//! NFT with ERC-2981 royalties, AccessControl, Burnable, and Upgradeable.
...
use stellar_tokens::non_fungible::{burnable::NonFungibleBurnable, royalties::NonFungibleRoyalties, Base, NonFungibleToken};
