//! Pausable SEP-41 fungible token with BlockList, AccessControl, Burnable, and Upgradeable.
...
use stellar_tokens::fungible::{burnable::FungibleBurnable, blocklist::{BlockList, FungibleBlockList}, ContractOverrides, Base, FungibleToken};
