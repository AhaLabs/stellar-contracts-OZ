...
fn create_client<'a>(e: &Env, owner: &Address, initial_supply: i128) -> ContractClient<'a> {
    let name = String::from_str(e, "Test Token");
    let symbol = String::from_str(e, "TST");
    let address = e.register(Contract, (name, symbol, 18u32, owner, 1_000_000i128, initial_supply));
