...
impl FungibleBlockList for BlockList {
    ...
    fn block_user(e: &Env, user: soroban_sdk::Address, _operator: Address) {
...
impl BlockList {
    ...
    pub fn transfer_from(e: &Env, spender: &Address, from: &Address, to: &Address, amount: i128) {
        ...
        // Call the base implementation
        Base::transfer_from(e, spender.clone(), from.clone(), to.clone(), amount);
    }
    ...
    pub fn approve(
        ...
        // Call the base implementation
        Base::approve(e, owner.clone(), spender.clone(), amount, live_until_ledger);
    }
}
